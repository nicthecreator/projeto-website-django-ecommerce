...
SECURE_SSL_REDIRECT = False # Desligado até termos um domínio com HTTPS
...
DATABASES = {
    'default': dj_database_url.config(default=env('DATABASE_URL', default='postgres://postgres:123456@localhost:5432/phd_store'))
}
